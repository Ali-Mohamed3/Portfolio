...
class TabletEducation extends StatefulWidget {
  const TabletEducation({super.key});

  @override
  State<TabletEducation> createState() => _TabletEducationState();
}

class _TabletEducationState extends State<TabletEducation> {
  @override
